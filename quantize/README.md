...
| Serving stack | vLLM (native support) | TRT-LLM |
...
**NVFP4**: sm_120-native block-wise FP4 weight format. Requires TRT-LLM engine build for serving; not yet supported by vLLM. Yields the highest compression ratio of the two formats.
